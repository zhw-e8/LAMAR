...
class EsmIntermediate(nn.Module):
    def __init__(self, config):
        ...
        # self.gelu=GELU()#此处更改为torch中GELU而非utils.model_utils.gelu
...
class EsmEmbeddings(nn.Module):
    ...
    def __init__(self, config):
        ...
        self.register_buffer(
            ...
            persistent=False,  ##TODO: CHECK THIS ARGUMENT
        )
...
class EsmResBlock(nn.Module):

    def __init__(self, nchannels, kernal_size, stride, padding, dilation):
        super().__init__()
        self.conv = nn.Conv1d(
